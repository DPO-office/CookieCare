...
//         <button onClick={onExecuteDraftStream} className="inline-flex items-center gap-2 hover:opacity-90 text-white text-[13px] font-semibold px-6 py-2.5 rounded-xl transition shadow-xs hover:shadow-sm cursor-pointer" style={{ background: "#2175D9" }}>
    ...
    <div className="w-full space-y-5 z-10">
      ...
      <div className="bg-white border border-gray-200 rounded-[18px] p-6 shadow-xs space-y-5">
        ...
        <textarea
          ...
          className="w-full bg-gray-50 border border-gray-200 rounded-xl p-4 text-[14px] text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-100 focus:border-gray-300 transition resize-none leading-relaxed"
        />
      </div>
      ...
      <div className="pt-2 pb-8 flex justify-start">
        <button
          ...
          className="inline-flex items-center gap-2 hover:opacity-90 text-white text-[13px] font-semibold px-6 py-2.5 rounded-xl transition shadow-xs hover:shadow-sm disabled:opacity-40 cursor-pointer" style={{ background: "#2175D9" }}
        >
          <span>Generate draft</span>
          <ArrowRight className="w-4 h-4" />
        </button>
