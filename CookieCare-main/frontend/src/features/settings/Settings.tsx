...
export default function SettingsView(_props: Partial<SettingsProps> = {}) {
  ...
  return (
    <div className="flex-1 flex flex-col md:flex-row overflow-hidden bg-[#FAFAFB]">

      {/* Mobile horizontal navigation tabs */}
      <div className="md:hidden shrink-0 border-b border-gray-200 bg-white px-4 py-2.5 overflow-x-auto">
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[12px] font-medium transition-all shrink-0 ${
                  isActive
                    ? "bg-[#2175D9] text-white shadow-xs"
      ...
      {/* Desktop Left nav */}
      <aside className="hidden md:flex w-[220px] shrink-0 border-r border-gray-200 bg-white flex-col overflow-y-auto scrollbar-none">
