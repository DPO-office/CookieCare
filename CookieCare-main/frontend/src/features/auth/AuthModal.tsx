      ...
      >
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              <div className="w-9 h-9 rounded-lg flex items-center justify-center"
                style={{ background: "#F3F4F6" }}>
                <Shield className="w-[18px] h-[18px]" style={{ color: "#1D6FD8" }} />
              </div>
              <span className="text-[17px] font-bold tracking-tight" style={{ color: "#1D6FD8" }}>randtrust</span>
            </div>
            <h1 className="text-[36px] font-bold leading-[1.2] tracking-tight mb-4 max-w-[400px]" style={{ color: "#1D6FD8" }}>
        ...
        <div className="flex-1 flex flex-col justify-center bg-white px-14 py-12">
          ...
          <div className="flex lg:hidden items-center gap-2 mb-8 justify-center">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ background: "#EBF2FD" }}>
              <Shield className="w-4 h-4" style={{ color: "#1D6FD8" }} />
            </div>
            <span className="text-[16px] font-bold" style={{ color: "#1D6FD8" }}>randtrust</span>
          </div>
          ...
          <AnimatePresence mode="wait">
            {viewState === "pending" ? (
              ...
              >
                <h2 className="text-[32px] font-bold tracking-tight mb-1.5" style={{ color: "#1D6FD8", letterSpacing: "-0.025em" }}>
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <motion.button id="auth-submit-btn" type="submit" disabled={loading || googleLoading}
                    ...
                    className="w-full flex items-center justify-center gap-2 py-3 rounded-xl text-[15px] font-semibold text-white transition-colors duration-150 disabled:opacity-60" style={{ background: "#1D6FD8" }}
                  >
