      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="bg-white border border-gray-200 rounded-[18px] shadow-xs p-6">
          ...
          <div className="flex gap-2">
            <button id="download-docx-btn" onClick={() => onDownload("docx")} className="inline-flex items-center gap-2 bg-gray-900 text-white hover:bg-gray-800 rounded-xl px-4 py-2.5 text-[13px] font-medium transition shadow-xs cursor-pointer">
              <FileDown className="w-3.5 h-3.5" /><span>DOCX</span>
            </button>
            <button id="download-pdf-btn" onClick={() => onDownload("pdf")} className="inline-flex items-center gap-2 bg-gray-900 text-white hover:bg-gray-800 rounded-xl px-4 py-2.5 text-[13px] font-medium transition shadow-xs cursor-pointer">
