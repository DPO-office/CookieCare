import type { VendorDimensionResult } from "../utils/categorizeFindings";

interface VendorDimensionCardProps {
  result: VendorDimensionResult;
  selected: boolean;
  onSelect: () => void;
  index: number;
}
...
export function VendorDimensionCard({ result, selected, onSelect, index }: VendorDimensionCardProps) {
