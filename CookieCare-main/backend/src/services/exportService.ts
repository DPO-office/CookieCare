...
<body>
  <div class="header">
    randtrust Digital Asset Vault • ${contentType.toUpperCase().replace("_", " ")}
    <br>Generated on ${new Date().toLocaleString()}
  </div>
  <h1>${title}</h1>
  <div class="content-area">${renderedContent}</div>
  <div class="footer">Confidential Document • Powered by randtrust Multi-Agent Legal Engine</div>
</body>
</html>`;
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `Generated by randtrust • ${new Date().toLocaleDateString()}`,
                size: 18,
                color: "888888",
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "Confidential Document \u2022 Powered by randtrust Multi-Agent Legal Engine",
                size: 16,
                color: "9CA3AF",
              }),
            ],
