 ...
 *
 * This augments the canonical requirement bundle without changing locked
 * results directly. The improved matrix is validated before Phase 5 uses it.
 */
...
} from "./verify-evidence-deterministically.js";
import type {
  Phase3Bundle,
  Phase3BundleItem,
  Phase3ScopeVector,
...
/** Public entry point for bounded canonical retrieval fallback. */
...
function retrievalCompleteFor(bundle: Phase3Bundle): boolean {
  if (bundle.investigationComplete !== undefined) return bundle.investigationComplete;
