...
import { resolveRule } from "./evaluate-rule-compliance.js";
import { insufficient } from "../shared/work-unit-utils.js";
import { groupedResultsToFindings, TIER_BY_SOURCE } from "../shared/convert-results-to-findings.js";
import {
  verifyProposition,
  verifyPropositionCandidates,
  type VerifyVerdict,
  type VerifyPropositionResult,
} from "../shared/proposition-verifier.js";
...
import { buildInMemoryIndex, type ClauseIndex } from "../shared/clause-index.js";
import { logVerifyCandidates } from "../shared/verification-inspection-log.js";
import { logRetrievalRanking, logSelectedCandidates } from "../shared/evidence-pool-log.js";
import { recordRetrievalPool } from "../compliance/diagnostics/index.js";
import {
  selectCandidates,
