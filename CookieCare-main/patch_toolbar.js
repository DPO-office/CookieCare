...
// Lines to replace: 1814 to 1944 (1-indexed) = indices 1813 to 1943 (0-indexed)
// Replace them with new toolbar + canvas opener
const startIdx = 1813; // 0-based, line 1814
const endIdx   = 1944; // 0-based, line 1945 (exclusive)
